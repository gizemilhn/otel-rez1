...
import { Building2, Home, Users, BedDouble, Calendar, LogOut } from 'lucide-react';
import { toast } from 'react-toastify';

const navigation = [
  { name: 'Genel Bakış', href: '/admin', icon: Home },
  { name: 'Kullanıcılar', href: '/admin/kullanicilar', icon: Users },
  { name: 'Oteller', href: '/admin/oteller', icon: Building2 },
  { name: 'Odalar', href: '/admin/odalar', icon: BedDouble },
