...
const navItems = [
  { name: 'Dashboard', path: '/yonetici', icon: LayoutDashboard },
  { name: 'Odalar', path: '/yonetici/odalar', icon: BedDouble },
  { name: 'Rezervasyonlar', path: '/yonetici/rezervasyonlar', icon: Calendar },
  { name: 'Ayarlar', path: '/yonetici/ayarlar', icon: Settings },
];
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        <div className="h-16 flex items-center justify-center border-b">
          <h1 className="text-xl font-bold text-gray-900">Otel Yönetimi</h1>
        </div>
        ...
        <nav className="mt-6">
          {navItems.map((item) => {
            ...
            // Aktiflik kontrolü: path ile başlıyorsa aktif
