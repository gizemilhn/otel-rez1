...
export default function OtelCard({ id, name, description, address, city, country, rating, imageUrl, price }: OtelCardProps) {
  return (
    <div className="group relative bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center text-gray-500 mb-4">
          ...
          <span className="text-sm">{address}, {city}, {country}</span>
        </div>
